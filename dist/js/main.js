...
var _GameState = __webpack_require__(118);
...
if (game.localStorageAvailable && !!localStorage.getItem(_constants.LOCAL_STORAGE_KEY)) {
    document.querySelector('svg text.high-score').textContent = localStorage.getItem(_constants.LOCAL_STORAGE_KEY);
}
...
exports.LOCAL_STORAGE_KEY = exports.ANTI_DIAGONAL = exports.MAIN_DIAGONAL = exports.Direction = exports.NEW_TILE_VALUE = undefined;
...
var LOCAL_STORAGE_KEY = exports.LOCAL_STORAGE_KEY = 'highScore';
...
var _Tile = __webpack_require__(119);
...
var GameState = function () {
    function GameState() {
        ...
        this.score = 0;
        this.localStorageAvailable = (0, _main.storageAvailable)('localStorage');
        if (this.localStorageAvailable && !localStorage.getItem(_constants.LOCAL_STORAGE_KEY)) {
            localStorage.setItem(_constants.LOCAL_STORAGE_KEY, 0);
        }
    }
    ...
    _createClass(GameState, [{
        ...
        value: function handleMove(direction) {
            ...
            document.querySelector('svg text.score').textContent = this.score;
            if (this.localStorageAvailable && this.score > localStorage.getItem(_constants.LOCAL_STORAGE_KEY)) {
                localStorage.setItem(_constants.LOCAL_STORAGE_KEY, this.score);
                document.querySelector('svg text.high-score').textContent = localStorage.getItem(_constants.LOCAL_STORAGE_KEY);
            }
